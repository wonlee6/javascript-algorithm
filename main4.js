...
// 자릿수의 합이 같은 경우 원래 숫자가 큰 수자를 답으로 한다
// 만약 235 와 1234가 동시에 답이 될수 있다면 1234를 답으로 출력

function solution01(n, arr) {
  let answer;

  return answer;
}

const arr01 = [128, 460, 603, 40, 521, 137, 123];
console.log(solution01(7, arr01)); // 137

// 2. 뒤집은 소수
// n개의 자연수가 입력되면 각 자연수를 뒤집은 후 그 뒤집은 수가 소수이면 그 소수를 출력
// 예) 32를 뒤집으면 23이고, 23은 소수이다. 그러면 23을 출력
// 910을 뒤집으면 19로 숫자화 해야 한다. 첫 자리부터의 0은 무시한다.
...
const arr02 = [32, 55, 62, 20, 250, 370, 200, 30, 100];
console.log(solution02(arr02)); // 23, 2, 73, 2, 3
...
console.log(solution03(arr03)); // 3
...
console.log(solution04(arr04)); // 4
...
function solution05(m, product) {
  let answer;

  return answer;
}

const arr05 = [13, 15, 34, 23, 45, 65, 33, 11, 26, 42];
console.log(solution05(arr05)); // 143
